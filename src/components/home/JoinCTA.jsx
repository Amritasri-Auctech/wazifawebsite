...
const JoinCTA = () => (
  <section className="py-16 sm:py-20 bg-white">
    <div className="max-w-[1280px] mx-auto px-4">
      <div className="bg-gradient-to-r from-green-700 to-green-600 rounded-2xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
          <Link
            to="/members/join"
            className="bg-white text-green-700 hover:bg-green-50 font-bold text-sm px-7 py-3 rounded transition-colors duration-200 text-center"
          >
            Join Now
          </Link>
          <Link
