      ...
      <div className="max-w-[1280px] mx-auto px-4">
        ...
        <div className="relative max-w-3xl mx-auto">
          <AnimatePresence mode="wait">
            ...
            >
              <FaQuoteLeft size={28} className="text-[#86c724] mx-auto mb-5 opacity-60" />
              ...
              <p className="text-[#86c724] text-sm">{testimonials[current].role}</p>
            </motion.div>
          </AnimatePresence>
            ...
            {testimonials.map((_, i) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  i === current ? "w-6 bg-[#86c724]" : "w-2 bg-gray-300"
                }`}
              />
            ))}
          </div>
